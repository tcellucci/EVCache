...
public class EVCacheTestDIArchaius1 extends Base implements EVCacheGetOperationListener<String> {
    private static final Logger log = LoggerFactory.getLogger(EVCacheTestDIArchaius1.class);
    private int loops = 10;

    public static void main(String args[]) {
        new EVCacheTestDIArchaius1().run();
    }
